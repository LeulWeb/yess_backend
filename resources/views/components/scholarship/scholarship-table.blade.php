...
<div class="relative overflow-x-auto shadow-md sm:rounded-lg">
    ...
    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        ...
        <tbody>
            ...
            @forelse ($scholarshipListings as $listing)
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td class="px-6 py-4">
                    {{$listing->program_duration}}


                </td>
                <td class="px-6 py-4">
                    <iconify-icon icon="ph:link-bold" style="color: blue;"></iconify-icon>
                    <a href="{{$listing->link}}" class="text-blue-500">Visit </a>
                </td>
                <td class="px-6 py-4">
                    {{$listing->country}}
                </td>
