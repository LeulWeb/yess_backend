<div>
    <div>
        ...
        <div class="flex justify-between items-center py-5 mb-8">
            <div>
                <h2 class="text-4xl font-extrabold dark:text-white">Trainer </h2>
            </div>

            {{-- button for creating trainer list --}}
            <div>
                <a wire:navigate href="{{ route('trainers.create') }}" type="button"
                ...
                <tbody>
                    ...
                    @forelse ($trainerList as $item)
                        <tr
                            ...
                            <td class="px-6 py-4">
                                <a href="{{ route('trainers.show', ['trainer' => $item]) }}"
