    ...
    <form wire:submit.prevent="create">
            ...
            <div>
                ...
                <div>
                    <div class="relative mb-1">
                        <label for="youtube_links">PlayList Links</label>                
                        <input type="url" id="input-group-1"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="playlist_link" wire:model.live.debounce.300ms='playlist_link'>
                    </div>
                       <div> @error('playlist_link')
                            <x-form.error :$message />
                        @enderror
                    </div>
                </div>
       ...
       <div class="mb-3">            
        ...
        <div class="grid grid-cols-2 gap-y-5 gap-x-3 mt-5">
            ...
            <button  type="submit" class="text-white w-full bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-4 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">New
                Training</button>
