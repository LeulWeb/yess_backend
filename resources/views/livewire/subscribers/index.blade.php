<div>
    ...
    <div class="flex justify-between items-center py-5 mb-8">
        <div>
            <h2 class="text-4xl font-extrabold dark:text-white">subscribers</h2>
        </div>
        {{-- button for creating Subscriber list --}}
        <div>
            <a wire:navigate href="{{ route('subscribers.create') }}" type="button"
            ...
            <tbody>
                ...
                @forelse ($subscriberList as $item)
                    <tr
                        ...
                        <td class="px-6 py-4">
                            <a href="{{ route('subscribers.show', ['subscriber' => $item]) }}"
                                    ...
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div class="p-4 md:p-5 text-center">
                                            ...
                                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are
                                                you sure to delete this {{ $item->id }}?</h3>
