<div>
    ...
    <div class="flex justify-between items-center py-5 mb-8">
        <div>
            <h2 class="text-4xl font-extrabold dark:text-white"> Company Volunteers </h2>
        </div>

        {{-- button for creating volunteer list --}}
        <div>
            <a wire:navigate href="{{ route('volunteers.create') }}" type="button"
            ...
            <tbody>
                ...
                @forelse ($volunteerList as $item)
                    <tr
                        ...
                        <td class="px-6 py-4">
                            <a href="{{ route('volunteers.show', ['volunteer' => $item]) }}"
