...
<div>
    ...
    <div class="flex justify-between items-center py-5 mb-8">
        <div>
            <h2 class="text-4xl font-extrabold dark:text-white">sponsers</h2>
        </div>

        {{-- button for creating startup list --}}
        <div>
            <a wire:navigate href="{{ route('sponsers.create') }}" type="button"
            ...
            <tbody>
                ...
                @forelse ($sponserList as $item)
                    <tr
                        ...
                        <td class="px-6 py-4">
                            <a href="{{ route('sponsers.show', ['sponser' => $item]) }}"
