<div>
    ...
    <div class="flex justify-between items-center py-5 mb-8">
        <div>
            <h2 class="text-4xl font-extrabold dark:text-white">Scholarship Listings</h2>
        </div>

        {{-- button for creating scholarship list --}}
        <div>
            <a wire:navigate href="{{ route('scholarships.create') }}" type="button"
            ...
            <tbody>
                ...
                @forelse ($scholarshipList as $item)
                    <tr
                        ...
                        <td class="px-6 py-4">
                            <a href="{{ route('scholarships.show', ['scholarship' => $item]) }}"
