<div>
    ...
    <div class="flex items-center justify-between py-5">
        ...
        <div class="flex space-x-3 items-cetner">
            ...
            <button data-modal-target="{{ $faq->id }}" data-modal-toggle="{{ $faq->id }}" type="button"
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="p-4 md:p-5 text-center">
                            ...
                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are
                                you sure you want to delete this {{ $faq->question }}?</h3>
                            <button wire:click='delete()' data-modal-hide="{{ $faq->id }}" type="button"
                                class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center me-2">
                                Yes, I'm sure
                            </button>
                            <button data-modal-hide="{{ $faq->id }}" type="button"
