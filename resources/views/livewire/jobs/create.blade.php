<div>
    ...
    <form wire:submit.prevent='create()' class="w-10/12 mx-auto" method="post" enctype="multipart/form-data">
        ...
        <label for="message" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white my-3">Addational
            Informations</label>
            ...
            <div>
                <div class="relative mb-6">
                    ...
                    <input type="date" id="input-group-1"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="" wire:model.live.debounce.300ms='deadline'>
        ...
        <div class="grid grid-cols-2 gap-4">
            <div>
                <label for="gender" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Applicant Needed</label>
            ...
            <input id="is_remote" type="checkbox" wire:model.defer="is_remote"
                class="form-checkbox h-4 w-4 text-indigo-600 transition duration-150 ease-in-out">
            <label for="is_remote" class="ml-2 text-sm text-gray-700 dark:text-white">is_remote</label>
            @error('is_remote')
