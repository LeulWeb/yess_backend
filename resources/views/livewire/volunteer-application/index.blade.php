<div>
    ...
    <div class="flex justify-between items-center py-5 mb-8">
        <div>
            <h2 class="text-4xl font-extrabold dark:text-white">Volunteers Application </h2>
        </div>
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                ...
                @forelse ($volunteerapplicationList as $item)
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td class="px-6 py-4">                           
                            {{ $item->volunteer->title }}                  
                      
                        </td>
                        <td class="px-6 py-4">                           
                            {{ $item->volunteer->contact_email }}                  
                        ...
                        <td class="px-6 py-4">
                            <a href="{{ route('volunteer-application.show', ['volunteerApplication' => $item]) }}"
        ...
        <div class="p-3">
            {{ $volunteerapplicationList->links() }}
        </div>
    </div>
