    ...
    <div>
        ...
        <div class="flex items-center justify-between py-5">
            ...
            <div class="flex space-x-3 items-cetner">
                ...
                <button data-modal-target="{{ $partner->id }}" data-modal-toggle="{{ $partner->id }}" type="button"
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div class="p-4 md:p-5 text-center">
                                ...
                                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are
                                    you sure you want to delete this {{ $partner->organization }}?</h3>
                                <button wire:click='delete()' data-modal-hide="{{ $partner->id }}" type="button"
                                    class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center me-2">
                                    Yes, I'm sure
                                </button>
                                <button data-modal-hide="{{ $partner->id }}" type="button"
                    ...
                    <form wire:submit.prevent='update()' class="w-10/12 mx-auto" method="post" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-2 gap-5">
                            ...
                            <div>
                                    ...
                                    <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white ">partner's
                                        Email</label>
            ...
            <div
                ...
                <div class="flex w-10/12 mx-auto items-center place-content-between ">
                    <div class="flex flex-col items-center  ">
                        <img class="w-24 h-24 mb-3 rounded-full shadow-lg" src="{{ asset($partner->logo) }}"
                            alt="Bonnie agreement_file" />
                        <div>
                            <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">{{ $partner->name }}</h5>
                            <p class="fromat">{{ $partner->organization }}</p>
                        </div>
                    </div>
                    ...
                    <div>
                        <div>
                            <p>Email</p>
                            <div>
                                <a class="flex space-x-1 items-center" href="mailto:{{ $partner->email }}">
