...
<div>
    ...
    <div class="flex justify-between items-center py-5 mb-8">
        <div>
            <h2 class="text-4xl font-extrabold dark:text-white">Partners</h2>
        </div>

        {{-- button for creating startup list --}}
        <div>
            <a wire:navigate href="{{ route('partners.create') }}" type="button"
            ...
            <tbody>
                ...
                @forelse ($partnerList as $item)
                    <tr
                        ...
                        <td class="px-6 py-4">
                            <a href="{{ route('partners.show-partner', ['partner' => $item]) }}"
                                    ...
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div class="p-4 md:p-5 text-center">
                                            ...
                                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are
                                                you sure you want to delete this {{ $item->organization }}?</h3>
