                ...
                <form wire:submit.prevent='update()' class="w-10/12 mx-auto" method="post" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-2 gap-5">
                        ...
                        <div>
                            ...
                            {{-- playlist --}}
                            <div>
                                <label for="product" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Playlist link</label>
                                <div class="relative mb-6">
                                    <div class="absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none">
                                        <iconify-icon icon="skill-icons:youtube"></iconify-icon>
                                    </div>
