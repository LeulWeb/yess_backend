<div>
    ...
    <div class="flex justify-between items-center py-5 mb-8">
        <div>
            <h2 class="text-4xl font-extrabold dark:text-white">Scholarship Request Listings</h2>
        </div>
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                ...
                @forelse ($scholarshipRequestList as $item)
                    <tr
                        ...
                        <td class="px-6 py-4">
                            <a href="{{ route('scholarship-request.show', ['scholarshipRequest' => $item]) }}"
