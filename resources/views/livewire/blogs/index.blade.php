<div>
    ...
    <div class="flex justify-between items-center py-5 mb-8">
        <div>
            <h2 class="text-4xl font-extrabold dark:text-white">Blogs</h2>
        </div>

        {{-- button for creating blog list --}}
        <div>
            <a wire:navigate href="{{ route('blogs.create') }}" type="button"
            ...
            <tbody>
                ...
                @forelse ($blogList as $item)
                    <tr
                        ...
                        <td class="px-6 py-4">
                            <a href="{{ route('blogs.show', ['blog' => $item]) }}"
                                    ...
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div class="p-4 md:p-5 text-center">
                                            ...
                                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are
                                                you sure to delete this {{ $item->title }}?</h3>
